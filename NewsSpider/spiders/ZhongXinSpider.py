...
class ZhongXinSpider(scrapy.Spider):
    ...
    def __init__(self, beginTime=None, endTime=None, *args, **kwargs):
        super(ZhongXinSpider, self).__init__(*args, **kwargs)
        self.beginTime=beginTime
        self.endTime=endTime
        self.start_urls = ['http://sou.chinanews.com.cn/search.do?q=%s&day1=%s&day2=%s&start=%s&field=title&channel=cul&ps=20' % (keyword,beginTime,endTime,self.page*20)]
